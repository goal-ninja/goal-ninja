...
(function() {
    ...
    var darkCSS = [
        ...
        d+' .mission-card,'+d+' .goal-card,'+d+' .habit-card{background:#1e1e1e;border-color:#333}',
        d+' .mission-card:hover,'+d+' .goal-card:hover,'+d+' .habit-card:hover{background:#252525}',
        d+' .mission-name,'+d+' .goal-name,'+d+' .habit-name{color:#f0f0f0}',
        d+' .mission-stat-value,'+d+' .goal-stat-value,'+d+' .habit-stat-value{color:#f0f0f0}',
        d+' .mission-stat-label,'+d+' .goal-stat-label,'+d+' .habit-stat-label{color:#777}',
        d+' .mission-meta,'+d+' .goal-meta,'+d+' .habit-meta{color:#777}',
        d+' .mission-progress,'+d+' .goal-progress{background:#333}',
